...
| Gemini     | gemini-3.5-flash   | ```export OAF_MODEL="(type: gemini, model: gemini-3.5-flash, key: 'your-key', timeout: 900000, temperature: 0)"``` |
...
| `/wiki reindex` | Rebuild wiki search indexes (JSON + Lucene; requires `wikiaccess=rw`) |
