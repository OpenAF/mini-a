...
try {
  ...
  print("QUALITY="+stringify({mode:mode,split:split,runtime:getVersion(),fixtureSha1:sha1(fixtureRaw),sourceSha1:{wiki:sha1(io.readFileString("mini-a-wiki.js")),knowledge:sha1(io.readFileString("mini-a-wiki-knowledge.js")),retrieval:io.fileExists("mini-a-wiki-retrieval.js")?sha1(io.readFileString("mini-a-wiki-retrieval.js")):null},samples:results.length,passageRecallAtK:mean("recall"),mrr:mean("reciprocalRank"),results:results},__,""))
