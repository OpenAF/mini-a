...
try {
  ...
  function classifyDebugTraceRecord(record) {
    ...
    if (kind === "tool_call" || kind === "shell_call" || kind === "wiki_call" || eventName === "mcp" || eventName === "exec" || eventName === "shell") return "calls"
    if (kind === "tool_result" || kind === "shell_result" || kind === "wiki_result") return "answers"
