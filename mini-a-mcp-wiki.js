...
function __miniAMcpWikiBuildConfig(args, options) {
  ...
  var cfg = {
    ...
    wikigraphcross      : isDef(args.wikigraphcross) ? toBoolean(args.wikigraphcross) : true,
    wikigraphcrossjoin  : isString(args.wikigraphcrossjoin) && args.wikigraphcrossjoin.trim().length > 0 ? args.wikigraphcrossjoin.trim() : "link,tag,alias,concept",
    wikigraphcrosscap   : isNumber(Number(args.wikigraphcrosscap)) ? Number(args.wikigraphcrosscap) : 5,
    wikigraphcrossdepth : isNumber(Number(args.wikigraphcrossdepth)) ? Number(args.wikigraphcrossdepth) : 1,
    wikigraphcrossmaxdf : isNumber(Number(args.wikigraphcrossmaxdf)) ? Number(args.wikigraphcrossmaxdf) : 0.25,
    wikigraphcrossminkeylen: isNumber(Number(args.wikigraphcrossminkeylen)) ? Number(args.wikigraphcrossminkeylen) : 3,
